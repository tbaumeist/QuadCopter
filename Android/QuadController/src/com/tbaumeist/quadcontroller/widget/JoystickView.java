...
public class JoystickView extends View {
	...
	public boolean getIsThrottle() {
		return this.throttleDown;
	}

	public void setIsThrottle(boolean isThrottleDown) {
		this.throttleDown = isThrottleDown;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (D) {
			...
			canvas.drawText(String.format("(%d, %d)", userX, userY),
	...
	private void returnHandleToCenter() {
		if (autoReturnToCenter) {
			...
			final double intervalsY = (orignY - touchY) / numberOfFrames;
